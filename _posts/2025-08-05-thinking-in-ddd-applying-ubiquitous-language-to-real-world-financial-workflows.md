...
flowchart TD
    ...
    C --> D[Inner Reconciliation in F & D]
...
* ***Inner Reconciliation***:	The process in GAL that matches Donation and Payment data to validate fund flow and trigger Payout.
