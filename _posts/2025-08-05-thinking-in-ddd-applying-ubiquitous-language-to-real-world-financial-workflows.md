...
Another challenge I face is that domain knowledge is easily forgotten. This means when picking up tasks in the same domain after some time, I often feel less confident and have to repeatedly familiarize myself with the details. Excessive repeated discussions can indeed dampen enthusiasm. As an engineer, this is one approach I’ve considered to address the issue—I hope it can be helpful to you as well.